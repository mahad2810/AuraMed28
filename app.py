...
@app.route("/hospital-landing")
def hospital_landing_page():
    return render_template("hospital_landing.html")
...
from patient_management import patient_management_bp
app.register_blueprint(patient_management_bp, url_prefix="/patient-management")
